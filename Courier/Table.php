...
<body style=" background-image: url(img/adam.jpeg); no-repeat center">
  <div id="header"></div>
  <div class="profile-card">
     <div class="top-section">
      <div class="pic">
         <img src="img/adam.jpeg" alt="" width="50%"height="50%">
       </div> <br>
        <div class="name">Adam</div>
        <div class="sname">Matric.No: <span>A19DW6969</span></div>
