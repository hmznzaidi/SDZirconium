...
$sql = "SELECT tblmemberships.*,tblbrands.BrandName,tblbrands.id as bid  from tblmemberships join tblbrands on tblbrands.id=tblmemberships.VehiclesBrand where tblmemberships.id=:vhid";
$query = $dbh -> prepare($sql);
$query->bindParam(':vhid',$vhid, PDO::PARAM_STR);
$query->execute();
    ...
    <div class="listing_detail_head row">
      ...
      <div class="col-md-3">
        <div class="price_info">
          <p>RM<?php echo htmlentities($result->PricePerDay);?> </p>Per Month
        ...
        <div class="listing_more_info">
          <div class="listing_detail_wrap">
            ...
            <ul class="nav nav-tabs gray-bg" role="tablist">
              <li role="presentation" class="active"><a href="#vehicle-overview " aria-controls="vehicle-overview" role="tab" data-toggle="tab">Membership Overview </a></li>

              <li role="presentation"><a href="#accessories" aria-controls="accessories" role="tab" data-toggle="tab">Add-Ons</a></li>
            </ul>
...
<?php
$bid=$_SESSION['brndid'];
$sql="SELECT tblmemberships.VehiclesTitle,tblbrands.BrandName,tblmemberships.PricePerDay,tblmemberships.FuelType,tblmemberships.ModelYear,tblmemberships.id,tblmemberships.SeatingCapacity,tblmemberships.VehiclesOverview,tblmemberships.Vimage1 from tblmemberships join tblbrands on tblbrands.id=tblmemberships.VehiclesBrand where tblmemberships.VehiclesBrand=:bid";
$query = $dbh -> prepare($sql);
