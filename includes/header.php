...
<header>
  <div class="default-header">
   ...
   <?php   if(strlen($_SESSION['login'])==0)
	{
?>
 <div style="float:right; margin-right:-100px; padding-right:-100px; padding:40px 0px;" class="login_btn"> <a href="#loginform" class="btn btn-xs uppercase" data-toggle="modal" data-dismiss="modal">Login / Register</a> </div>
<?php }
else{
