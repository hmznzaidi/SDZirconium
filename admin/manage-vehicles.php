...
$sql = "delete from tblmemberships SET id=:status WHERE  id=:delid";
...
<?php $sql = "SELECT tblmemberships.VehiclesTitle,tblbrands.BrandName,tblmemberships.PricePerDay,tblmemberships.FuelType,tblmemberships.ModelYear,tblmemberships.id from tblmemberships join tblbrands on tblbrands.id=tblmemberships.VehiclesBrand";
$query = $dbh -> prepare($sql);
$query->execute();
