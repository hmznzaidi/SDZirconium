...
{ ?>
          <ul>
            <li>
              ...
              <div class="contact_info_m">Bukit Jalil, Kuala Lumpur, Malaysia</div>
            </li>
            <li>
              <div class="icon_wrap"><i class="fa fa-phone" aria-hidden="true"></i></div>
              <div class="contact_info_m"><a href="tel:03-26154100">+60 13-317-4100</a></div>
            </li>
            <li>
              <div class="icon_wrap"><i class="fa fa-envelope-o" aria-hidden="true"></i></div>
              <div class="contact_info_m"><a href="mailto:kahxuan2001@graduate.utm.my">danielyusoff08@gmail.com</a></div>
            </li>
          </ul>
        <?php }} ?>
        </div>
