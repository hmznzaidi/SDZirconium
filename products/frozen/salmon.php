...
<article class="gallery-wrap"> 
	<div class="img-big-wrap">
	   <a href="../images/items/frozen/salmon.jpg"><img src="../images/items/frozen/salmon.jpg"></a>
	</div> <!-- img-big-wrap.// -->
	<div class="thumbs-wrap">
	  <a href="../images/items/frozen/salmon1.jpg" class="item-thumb"> <img src="../images/items/frozen/salmon1.jpg"></a>
	  <a href="../images/items/frozen/salmon2.jpg" class="item-thumb"> <img src="../images/items/frozen/salmon2.jpg"></a>
	</div> <!-- thumbs-wrap.// -->
...
<div class="mb-3"> 
	<var class="price h4">RM140.00</var> 
	<span class="text-muted">/per kg</span> 
</div> 

<p> The best salmon in the whole world is Salmon King also known as Chinook salmon from New Zealand. It is known for it's high content of healthy omega-3 oils & its big taste. </p>

<dl class="row">
  <dt class="col-sm-3">Type</dt>
  <dd class="col-sm-9">Fish fillet</dd>
